...
const es = {
    ...
    armory: {
        ...
        PLAYER_NOT_FOUND: "No pude encontrar al jugador {player}, asegúrate de haber escrito correctamente el nombre o de que el jugador exista.",
        NO_CHARACTERS: "El jugador no tiene ningún personaje.",
        NO_CHARACTER: "No se encontró ningún personaje, asegúrate de haber escrito correctamente el nombre o de que al menos exista un personaje.",
    ...
    embeds: {
        ...
        HELP: {
            ...
            DESCRIPTION: "Aquí tienes una lista de todos mis comandos. ¡Pronto agregaremos la capacidad de obtener más información sobre cada comando!",
        },
        INFO: {
            STATISTICS_TITLE: "Estadísticas",
            ...
            DESCRIPTION: "{username} es un bot de Discord que proporciona información sobre Diablo 4 desarrollado por glazk0 y Marco.",
        },
        SETTINGS: {
